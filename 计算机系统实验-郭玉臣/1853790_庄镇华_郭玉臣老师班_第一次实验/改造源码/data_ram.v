...
module data_ram(
	...
	always @ (posedge clk) begin
		if (ce == `ChipDisable) begin
			//data_o <= ZeroWord;
			  ...
			  if (sel[3] == 1'b1) begin
		      data_mem3[addr[`DataMemNumLog2+1:2]-17'b0_0100_0000_0000_0000] <= data_i[31:24];
		    end
			  if (sel[2] == 1'b1) begin
    ...
    assign debugreg={data_mem3[17'b0_0000_0000_0000_0000],
                           data_mem2[17'b0_0000_0000_0000_0000],
                           data_mem1[17'b0_0000_0000_0000_0000],
                           data_mem0[17'b0_0000_0000_0000_0000]};
endmodule