...
/*
 * @file	ucos/xlnx_common/sys.h
 * @brief	uC/OS xlnx_common system primitives for libmetal.
 */
...
#ifndef __METAL_UCOS_XLNX_COMMON_SYS__H__
#define __METAL_UCOS_XLNX_COMMON_SYS__H__
...
#endif /* __METAL_UCOS_XLNX_COMMON_SYS__H__ */
