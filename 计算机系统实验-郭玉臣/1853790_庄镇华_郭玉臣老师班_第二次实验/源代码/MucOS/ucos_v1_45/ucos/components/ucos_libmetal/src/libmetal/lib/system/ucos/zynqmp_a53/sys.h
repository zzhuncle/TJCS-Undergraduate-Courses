...
/*
 * @file	ucos/zynqmp_a53/sys.h
 * @brief	uC/OS zynqmp_a53 system primitives for libmetal.
 */

#ifndef __METAL_UCOS_SYS__H__
#error "Include metal/sys.h instead of metal/system/ucos/@PROJECT_MACHINE@/sys.h"
#endif

#include <metal/system/@PROJECT_SYSTEM@/xlnx_common/sys.h>
#include "xscugic.h"

#ifndef __METAL_UCOS_ZYNQMP_A53_SYS__H__
#define __METAL_UCOS_ZYNQMP_A53_SYS__H__
...
#endif /* __METAL_UCOS_ZYNQMP_A53_SYS__H__ */
