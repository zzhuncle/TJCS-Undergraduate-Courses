...
HD_PWD='E:/MucOS/MucOS.runs/design_1_dlmb_bram_if_cntlr_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_dlmb_bram_if_cntlr_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_dlmb_bram_if_cntlr_3.tcl
