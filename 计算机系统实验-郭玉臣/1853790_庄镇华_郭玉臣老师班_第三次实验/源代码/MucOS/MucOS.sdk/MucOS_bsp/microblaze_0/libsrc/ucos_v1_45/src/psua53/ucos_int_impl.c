...
*
* Argument(s) : src_id         Unused by the current implementation
*
* Return(s)   : none.
*
* Caller(s)   : Exception vectors declared in os_cpu_a.s.
*
* Note(s)     : (1) We invoke the exception handlers set through the Xil_Exception mechanism.
*
*               (2) OS port only services IRQ exceptions currently.
*********************************************************************************************************
*/
